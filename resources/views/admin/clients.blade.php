...
<div class="modal fade" id="addClientModal" tabindex="-1" role="dialog" aria-labelledby="addClientModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addClientForm" method="POST" action="{{ route('admin.clients.store') }}">
                    @csrf
                    <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('admin.clients.update', $client->id) }}" method="POST">
                        ...
                        @method('PUT')
                        <div class="form-group">
                            <label for="editClientName{{ $client->id }}">Client Name</label>
                            <input type="text" class="form-control" id="editClientName{{ $client->id }}" name="name" value="{{ $client->name }}" required>
                        </div>
...
@endforeach
                ...
                <ul>
                        ...
                        <li class="has-submenu">
                            ...
                            <ul class="submenu">
                                ...
                                <li class="active"><a href="/adminclients">Clients</a></li>
            ...
            <div class="content">
              <div class="row">
                ...
                <div class="col-sm-8 col-9 text-right m-b-20">
                  <button class="btn btn-primary btn-rounded float-right" data-toggle="modal" data-target="#addClientModal">
    ...
    <div class="dropdown-menu dropdown-menu-right">
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#editClientModal{{ $client->id }}" data-id="{{ $client->id }}"><i class="fa fa-pencil m-r-5"></i> Edit</a>
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#deleteClientModal{{ $client->id }}" data-id="{{ $client->id }}"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
    </div>
</div>

            <div class="card-body">
                <h4 class="expertise-title text-ellipsis"><a href="#">{{ $client->name }}</a></h4>
            </div>
        </div>
    </div>
@endforeach
